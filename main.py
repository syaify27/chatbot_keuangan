...
def main():
    ...
    if not st.session_state.api_key_configured:
        st.error("Kunci API Google (GOOGLE_API_KEY) tidak dikonfigurasi atau tidak valid. Harap periksa [Manage app] > [Settings] > [Secrets] dan pastikan Penagihan (Billing) aktif di proyek Google Cloud Anda.")
        st.stop()
